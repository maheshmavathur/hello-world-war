...
stage (Push) {
			...
			sh "docker login -u maheshmavathur.jfrog.io.jfrog.io -p ${jfrogpass}"
}			
            }
			
			docker tag imageone:1.0 maheshmavathur.jfrog.io/imageone/imageone:1.0
			docker push maheshmavathur.jfrog.io/imageone/imageone:1.0
	}
  }
}
